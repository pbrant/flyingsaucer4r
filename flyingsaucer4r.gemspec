...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/flyingsaucer4r.rb", "lib/flyingsaucer4r/version.rb", "lib/itext-2_0_8_02.jar", "lib/pdffilter.rb", "lib/xhtmlrenderer20081112-core-renderer.jar", "test/test_pdffilter.rb"]
  s.has_rdoc = true
  s.rdoc_options = ["--main", "README.txt"]
  s.require_paths = ["lib"]
  s.rubyforge_project = %q{flyingsaucer4r}
